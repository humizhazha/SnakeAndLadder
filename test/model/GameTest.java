...
public class GameTest {
	...
	Map<Integer, TelePort> initTeleportList() {
		TelePort snake = new Snake(68, 74);
		TelePort ladder = new Ladder(54, 90);
		Map<Integer, TelePort> teleportMap = new HashMap<Integer, TelePort>() {
			{
				put(snake.eventPosition(), snake);
				put(ladder.eventPosition(), ladder);
			}
		};
		return teleportMap;
	}
